...
PICS = (environ.get('PICS', 'https://iili.io/F9gSIWb.md.jpg https://iili.io/F9gS2sf.md.jpg https://i.postimg.cc/y8pgYTh7/19.png')).split()
...
# Channels
INDEX_CHANNELS = [int(index_channels) if index_channels.startswith("-") else index_channels for index_channels in environ.get('INDEX_CHANNELS', '-1002519709347').split()]
...
# MongoDB information
DATA_DATABASE_URL = environ.get('DATA_DATABASE_URL', "mongodb+srv://altof2:123Bonjoure@cluster0.s1suq.mongodb.net/?retryWrites=true&w=majority&appName=Cluster0")
if len(DATA_DATABASE_URL) == 0:
    logger.error('DATA_DATABASE_URL is missing, exiting now')
    exit()
FILES_DATABASE_URL = environ.get('FILES_DATABASE_URL', "mongodb+srv://Ethan:Ethan123@telegrambots.lva9j.mongodb.net/?retryWrites=true&w=majority&appName=TELEGRAMBOTS")
...
FILMS_LINK = environ.get('FILMS_LINK', 'https://t.me/ZFlixTeam')
TUTORIAL = environ.get("TUTORIAL", "https://t.me/Kingcey")
VERIFY_TUTORIAL = environ.get("VERIFY_TUTORIAL", "https://t.me/Kingcey")

# Bot settings
DELETE_TIME = int(environ.get('DELETE_TIME', 33600)) # Add time in seconds
CACHE_TIME = int(environ.get('CACHE_TIME', 300))
MAX_BTN = int(environ.get('MAX_BTN', 20))
LANGUAGES = [language.lower() for language in environ.get('LANGUAGES', 'french english').split()]
...
PM_FILE_DELETE_TIME = int(environ.get('PM_FILE_DELETE_TIME', '33600'))
...
BIN_CHANNEL = environ.get("BIN_CHANNEL", "-1002376378205")
...
STICKERS = [sticker for sticker in environ.get('STICKERS', 'CAACAgQAAxkBAAIxQWg7j07gjwU7bOpK6Fgs7J15_1w3AAIXDAACwJTAUI5goy7WhXGiHgQ CAACAgIAAxkBAAEN1pBntL9sz1tuP_qo0bCdLj_xQa28ngACxgEAAhZCawpKI9T0ydt5RzYE').split()]  # Multiple sticker can be used separated by space, use @idstickerbot for get sticker id
